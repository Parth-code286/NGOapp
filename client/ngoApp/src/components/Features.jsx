    ...
    <section className="features" id="features">
      <div className="container">
        <div className="section-header text-center">
          ...
          <h2 className="section-title">Everything you need to run <br/>successful <span className="text-primary">volunteer events</span></h2>
        ...
        <div className="features-grid">
          ...
          <div className="feature-card">
            ...
            <h3 className="feature-title">Centralized Volunteer Portal</h3>
            <p className="feature-desc">
              Post your upcoming events and allow volunteers to discover and register securely. Build a dedicated community eager to help your cause.
            </p>
          </div>
          ...
          <div className="feature-card highlighted-card">
            <div className="feature-content">
              ...
              <h3 className="feature-title text-white">Automated Attendance</h3>
              <p className="feature-desc text-white-muted">
                Ditch the clipboard. Track participation in real-time, generate instant engagement reports, and reward your most active volunteers effortlessly.
              </p>
            </div>
          ...
          <div className="feature-card">
            ...
            <h3 className="feature-title">Instant Notification Hub</h3>
            <p className="feature-desc">
              Broadcast critical updates, shift changes, or last-minute announcements to all registered attendees simultaneously via email or SMS.
            </p>
          </div>
        </div>
      </div>
